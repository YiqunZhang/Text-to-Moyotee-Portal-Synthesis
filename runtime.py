...
parser.add_argument("--save_path", default='savedir')
parser.add_argument("--inference", default=False, action='store_true')
parser.add_argument('--pre_trained_disc', default='')
parser.add_argument('--pre_trained_gen', default='')
# parser.add_argument('--pre_trained_disc', default='checkpoints/savedir/disc_50.pth')
# parser.add_argument('--pre_trained_gen', default='checkpoints/savedir/gen_50.pth')
parser.add_argument('--dataset', default='moyotee')
